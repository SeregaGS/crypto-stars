...
Работа **по техническому заданию и критериям от HTML Academy**. Цель проекта - реализовать полноценный интерфейс криптобиржи Cryptostarts с возможеостью **покупать и продавать криптовалюту KEKS**.
...
src/
 ...
 ├── counterparties.js     - Рендер списка контрагентов
 ├── dom-helpers.js        - Селекторы и константы
 ├── filter.js             - Логика фильтрации
 ├── main.js               - Точка входа
 ├── map.js                - Работа с картой и пинами
 ├── modal.js              - Модальные окна
 ├── toggle.js             - Логика переключения вкладок
 ├── user.js               - Отрисовка профиля пользователя
 ├── util.js               - Утилиты
